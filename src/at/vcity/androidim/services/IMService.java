...
import at.vcity.androidim.tools.*;
...
*/
	 ...
	 * @param msg
	 **/
    private void showNotification(String nick, String msg)
	{
        // Set the icon, scrolling text and TIMESTAMP
    	String title = "AndroidIM: You got a new Message! (" + nick + ")";
...
//        i.putExtra(FriendInfo.USERNAME, nick);
//        i.putExtra(MessageInfo.MESSAGETEXT, msg);
        ...
        mBuilder.setContentText("New message from " + nick + ": " + msg);
	...
	{
        AndroidFacebookConnectActivity afca = new AndroidFacebookConnectActivity();
        afca.
